...
export interface ImmutableERC721HybridBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface ImmutableERC721HybridBase extends BaseContract {
  connect(runner?: ContractRunner | null): ImmutableERC721HybridBase;
  waitForDeployment(): Promise<this>;

  interface: ImmutableERC721HybridBaseInterface;
