...
export declare namespace ERC721Hybrid {
  ...
  export type MintStruct = { to: AddressLike; quantity: BigNumberish };

  export type MintStructOutput = [to: string, quantity: bigint] & {
    to: string;
    quantity: bigint;
  };
...
export interface SampleImmutableERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface SampleImmutableERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): SampleImmutableERC721;
  waitForDeployment(): Promise<this>;

  interface: SampleImmutableERC721Interface;
  ...
  mintBatchByQuantity: TypedContractMethod<
    [mints: ERC721Hybrid.MintStruct[]],
    [void],
    "nonpayable"
  >;

  mintBatchByQuantityThreshold: TypedContractMethod<[], [bigint], "view">;

  mintByQuantity: TypedContractMethod<
  ...
  safeMintBatchByQuantity: TypedContractMethod<
    [mints: ERC721Hybrid.MintStruct[]],
    [void],
    "nonpayable"
  >;

  safeMintByQuantity: TypedContractMethod<
    [to: AddressLike, quantity: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "mintBatchByQuantity"
  ): TypedContractMethod<
    [mints: ERC721Hybrid.MintStruct[]],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "mintBatchByQuantityThreshold"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "mintByQuantity"
  ): TypedContractMethod<
    [to: AddressLike, quantity: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "safeMintBatchByQuantity"
  ): TypedContractMethod<
    [mints: ERC721Hybrid.MintStruct[]],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "safeMintByQuantity"
  ): TypedContractMethod<
    [to: AddressLike, quantity: BigNumberish],
    [void],
    "nonpayable"
